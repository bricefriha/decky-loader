...
const UninstallModal = lazy(
  () => import("../../../../components/modals/UninstallModal"),
);
    ...
    <DialogBody>
      <DialogControlsSection>
        <DialogControlsSectionHeader>
          {t("SettingsGeneralIndex.updates.header")}
        </DialogControlsSectionHeader>
        <UpdaterSettings />
      </DialogControlsSection>
      <DialogControlsSection>
        <DialogControlsSectionHeader>
          {t("SettingsGeneralIndex.beta.header")}
        </DialogControlsSectionHeader>
        <BranchSelect />
        <StoreSelect />
      </DialogControlsSection>
      <DialogControlsSection>
        <DialogControlsSectionHeader>
          {t("SettingsGeneralIndex.notifications.header")}
        </DialogControlsSectionHeader>
        <NotificationSettings />
      </DialogControlsSection>
      <DialogControlsSection>
        <DialogControlsSectionHeader>
          {t("SettingsGeneralIndex.other.header")}
        </DialogControlsSectionHeader>
      ...
      <DialogControlsSection>
        <DialogControlsSectionHeader>
          {t("SettingsGeneralIndex.about.header")}
        </DialogControlsSectionHeader>
        <Field
          label={t("SettingsGeneralIndex.about.decky_version")}
          focusable={true}
        >
      ...
      <DialogControlsSection>
        <DialogControlsSectionHeader>
          {t("SettingsGeneralIndex.other.uninstall.label")}
        </DialogControlsSectionHeader>
        <DialogBody>
          <Field
            label={t("SettingsGeneralIndex.other.uninstall.description")}
            focusable={true}
          />
          <DialogControlsSection>
